...
export function HeroSection() {
  ...
  return (
    <section className="flex  h-full mx-auto  flex-col items-center justify-center text-center relative bg-grid-pattern">
      <div className="absolute top-[43%] left-1/2 -translate-x-1/2 -translate-y-1/2 w-full mt-20">
        ...
        >
          ...
          <span data-cursor="linkedin" className="text-sm font-medium text-green-700">
