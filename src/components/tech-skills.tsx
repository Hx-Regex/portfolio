    ...
    <section className="">
      <div className="container  mx-auto ">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4  scale-95 divide-gray-700  dark:divide-gray-700">
          {/* DATABASE */}
          <div className="p-5   dark:border-gray-700 border-r border-b border-l border-gray-300  relative">
            <h3 className="text-lg font-bold mb-4 uppercase tracking-wide text-center text-gray-800 dark:text-gray-200">
              DATABASE
            </h3>
            <div className="grid grid-cols-3 gap-2">
              <TechCard icon={<SiPostgresql className="text-blue-700 h-6 w-6" />} name="PostgreSQL" description="Advanced relational database with JSON support" />
              <TechCard icon={<SiMongodb className="text-green-700 h-6 w-6" />} name="MongoDB" description="Flexible NoSQL document database" />
              <TechCard icon={<SiMysql className="text-blue-600 h-6 w-6" />} name="MySQL" description="Popular relational database" />
              <TechCard icon={<SiRedis className="text-red-600 h-6 w-6" />} name="Redis" description="In-memory data structure store" />
              <TechCard icon={<SiPrisma className="text-blue-800 h-6 w-6" />} name="Prisma" description="Next-generation ORM for Node.js" />
            </div>
          ...
          {/* BACKEND TOOLS */}
          <div className="p-5  dark:border-gray-700 border-r border-b border-gray-300  relative">
            <h3 className="text-lg font-bold mb-4 uppercase tracking-wide text-center text-gray-800 dark:text-gray-200">
              BACKEND
            </h3>
            <div className="grid grid-cols-3 gap-2">
              <TechCard icon={<SiNodedotjs className="text-green-600 h-6 w-6" />} name="Node.js" description="JavaScript runtime built on Chrome's V8" />
              <TechCard icon={<SiExpress className="text-gray-700 h-6 w-6" />} name="Express" description="Fast, minimalist web framework" />
              <TechCard icon={<SiFastapi className="text-green-500 h-6 w-6" />} name="FastAPI" description="Modern Python web framework" />
              <TechCard icon={<SiTrpc className="text-blue-600 h-6 w-6" />} name="tRPC" description="TypeScript-first API framework" />
            </div>
          ...
          {/* FRONTEND */}
          <div className="p-5   dark:border-gray-700 border-gray-300 border-r border-b relative ">
            <h3 className="text-lg font-bold mb-4 uppercase tracking-wide text-center text-gray-800 dark:text-gray-200">
              FRONTEND
            </h3>
            <div className="grid grid-cols-3 gap-2">
              <TechCard icon={<SiReact className="text-cyan-500 h-6 w-6" />} name="React" description="Popular JavaScript library for UIs" />
              <TechCard icon={<SiNextdotjs className="text-gray-900 h-6 w-6" />} name="Next.js" description="Production-ready React framework" />
              <TechCard icon={<SiTypescript className="text-blue-600 h-6 w-6" />} name="TypeScript" description="JavaScript with static type definitions" />
              <TechCard icon={<SiTailwindcss className="text-cyan-500 h-6 w-6" />} name="Tailwind" description="Utility-first CSS framework" />
              <TechCard icon={<SiJavascript className="text-yellow-500 h-6 w-6" />} name="JavaScript" description="Dynamic programming language" />
              <TechCard icon={<SiFramer className="text-purple-600 h-6 w-6" />} name="Framer" description="Interactive design and prototyping" />
              <TechCard icon={`<svg xmlns="http://www.w3.org/2000/svg" width="46" fill="none" viewBox="0 0 82 30">
...
`} name="GSAP" description="JavaScript animation library" />
            </div>
            <div className="bg-background absolute -right-3 -bottom-3 text-gray-400">
              <Plus className="w-6 h-6" />
            </div>
          ...
          {/* TESTING */}
          <div className="p-5 border-gray-300 border-b border-r relative">
            <h3 className="text-lg font-bold mb-4 uppercase tracking-wide text-center text-gray-800 dark:text-gray-200">
              TESTING
            </h3>
            <div className="grid grid-cols-3 gap-2">
              <TechCard icon={<SiJest className="text-red-600 h-6 w-6" />} name="Jest" description="JavaScript testing framework" />
            </div>
            <div className="bg-background absolute -right-3 -bottom-3 text-gray-400">
              <Plus className="w-6 h-6" />
            </div>
          ...
          <div className="p-5 border-gray-300 border-r">
            ...
            <div className="grid grid-cols-3 gap-2">
              <TechCard icon={<SiStripe className="text-purple-700 h-6 w-6" />} name="Stripe" description="Online payment processing" />
              {/* <TechCard icon={<SiAuth0 className="text-red-600 h-6 w-6" />} name="Auth0" description="Identity and access management" /> */}
              <TechCard icon={<SiLemonsqueezy className="text-yellow-400 h-6 w-6" />} name="Lemonsqueezy" description="Online payment processing" />

              <TechCard icon={'<img src="/assets/tools/onafriq.png" alt="ONAFRIQ logo" className="h-8 w-auto" />'} name="Onafriq" description="Pan-African payments company" />
              <TechCard icon={'<img src="https://camo.githubusercontent.com/243909f00e726430f4d7e31c0f5e5c87e3abde526714482c806445852907d319/68747470733a2f2f6e6578742d617574682e6a732e6f72672f696d672f6c6f676f2f6c6f676f2d736d2e706e67" alt="NextAuth logo" className="h-8 w-auto" />'} name="NextAuth" description="Authentication for Next.js" optimize={false} />
          ...
          <div className="p-5 border-r border-gray-300">
            ...
            <div className="grid grid-cols-3 gap-2">
              <TechCard icon={<SiExpress className="text-gray-700 h-6 w-6" />} name="REST" description="Representational State Transfer API" />
              <TechCard icon={<SiGraphql className="text-pink-600 h-6 w-6" />} name="GraphQL" description="Query language for APIs" />
              <TechCard icon={<SiWebrtc className="text-blue-600 h-6 w-6" />} name="WebSockets" description="Real-time bidirectional communication" />
            </div>
          </div>
        </div>
      </div>
...
function TechCard({ icon, name, description, optimize = true }: { icon: React.ReactNode | string, name: string, description: string, optimize?: boolean }) {
  const renderIcon = () => {
    if (typeof icon === 'string') {
      // Check if it's an image path
      if (icon.includes('<img') && icon.includes('src=')) {
      ...
      return <div className="h-8 flex items-center justify-center mb-2" dangerouslySetInnerHTML={{ __html: icon }} />;
    }
    // If it's a React component, render it normally
    return <div className=" flex items-center justify-center mb-2">{icon}</div>;
  };
  ...
  return (
    <Tooltip>
          ...
          <Card className="border border-gray-400  shadow-sm hover:shadow-lg transition-all duration-300 rounded-lg hover:scale-105 cursor-pointer aspect-square">
            <CardContent className="p-3 h-full flex flex-col items-center justify-center">
              ...
              <div className="text-center">
                <h4 className="font-medium text-gray-900 text-xs">{name}</h4>
              </div>
            </CardContent>
          </Card>
      ...
      <TooltipContent className="bg-white border-2  border-b-4 border-black rounded-sm shadow-sm text-black">
        <h2 className="text-md font-bold text-center">{name}</h2>
