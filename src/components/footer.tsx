...
export default function Footer() {
    return (
        <footer className="container mx-auto py-8 md:py-8 w-full">
            <div className="px-4 md:px-6">
                ...
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 md:gap-0 mb-6">
                    <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-6">
                        ...
                        <a href="/terms" className="text-gray-600 text-xs sm:text-sm hover:text-gray-900 transition-colors underline">
                ...
                <div className="text-center space-y-6 md:space-y-8">
                    <h1 className="text-3xl sm:text-4xl md:text-6xl lg:text-8xl font-bold text-gray-900 tracking-wider md:tracking-widest uppercase font-serif leading-tight">
                        IsmailChabane.com
                    </h1>
                </div>
            </div>
